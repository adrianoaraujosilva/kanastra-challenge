...
class BoletosController extends Controller
{
     ...
     */
    public function show(BoletosController $boletosController, $id)
    {
        dd($id, $boletosController);
        // if (is_numeric($boletosController))
        $boletosController = $this->boletos->find($boletosController);
