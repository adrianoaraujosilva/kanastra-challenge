...
class BoletosController extends Controller
{
     ...
     */
    public function update(Request $request, BoletosController $boletosController, $id): JsonResponse
    {
        $request->validate([
            "debt_id"       => "uuid|unique:boletos,debt_id,{$request->debt_id}",
            "name"          => "required|string|max:100",
            "government_id" => "required|integer",
            "email"         => "required|email",
            "debtAmount"    => "required|numeric",
        ...
        dd($boletosController, $request->all());
