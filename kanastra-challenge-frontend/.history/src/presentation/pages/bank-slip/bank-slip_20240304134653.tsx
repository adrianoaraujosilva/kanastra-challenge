...
function BankSlipComponent(props: Readonly<BankSlipProps>): ReactElement {
  const { bankSlips } = useFileContext();
  // const { loadBankSlips } = useBankSlipsContext();

  // console.log("useBankSlips:", useBankSlips());
  console.log("useBankSlips:", bankSlips);
